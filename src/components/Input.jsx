...
export default function Input({ icon: Icon, type, placeholder, autoComplete, onChange }) {
  ...
  return (
    <div className='relative w-full'>
      ...
      ></Icon>
      <input
        className=' pl-8 w-full placeholder:text-gray-400 border-0 border-b border-gray-400 outline-none px-1 py-0 bg-transparent focus:border-primary-end transition-colors duration-400'
        type={type}
